...
<div class="container">
  ...
  <?php } ?>
  <div class="row">
      <div class=" col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-9 col-sm-offset-2  col-xs-12 ">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="account_register text-center ">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <?php if ($text_agree) { ?>
        <div class="buttons">
          <div class="pull-center "><?php echo $text_agree; ?>
            <?php if ($agree) { ?>
            ...
            &nbsp;
            <br>
            <input type="submit" value="<?php echo $button_continue; ?>" class="btn product_btn_buy" style="margin-top: 10px" />
