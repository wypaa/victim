    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover cart_basket">
          <thead>
            <tr>
              <td style="box-shadow:  0px 3px 4px -2px #E4CD96" class="text-center"><?php echo $column_image; ?></td>
              <td style="box-shadow:  0px 3px 4px  -2px #EA837B"class="text-left"><?php echo $column_name; ?></td>
              <td  style="box-shadow: 0px 3px 4px  -2px #D2D7D0" class="text-left"><?php echo $column_model; ?></td>
              <td style="box-shadow: 0px 3px 4px -2px #7BC6EA" class="text-right"><?php echo $column_stock; ?></td>
              <td  style="box-shadow: 0px 3px 4px -2px #EA7BA5" class="text-right"><?php echo $column_price; ?></td>
              <td   style="box-shadow: 0px 3px 4px -2px #93EA7B" class="text-right"><?php echo $column_action; ?></td>
            </tr>
          </thead>
          <tbody>
