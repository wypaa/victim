<div class="row">
  ...
  <div class="col-sm-6">
   ...
   <!--   <div class="form-group ">
		...
		<p>
        <input type="radio" name="company" value="Нова Почта" id="input-payment-company" onclick="myFunction(1)" checked="checked"> Нова Почта.
		<br>
		<input type="radio" name="company" value="Укрпочта"   id="input-payment-company" onclick="myFunction(2)"> Укрпочта.
		</p>
      </div>
	  <script>
		function myFunction(a) {
		if (a==1){
		document.getElementById("adr").innerHTML  ="<?php echo $entry_address_2; ?>";
		document.getElementById("input-payment-address-2").placeholder = "<?php echo $entry_address_2; ?>";
		}
		if(a==2){ 
		document.getElementById("adr").innerHTML  ="<?php echo $entry_fax; ?>";
		document.getElementById("input-payment-address-2").placeholder = "<?php echo $entry_fax; ?>";
		}
		}
		</script> -->
	      <div class="form-group required">
      ...
      <div class="form-group required"   style="display: block">
        <label class="control-label" id="adr" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
	  ...
	  <!-- <div class="form-group "   style="display:none">
        <label class="control-label"    for="input-payment-fax" style="dis"><?php echo $entry_fax; ?></label>
