...
<form class="form-horizontal" >
  ...
  <div id="payment-new" style="display: block">
	...
	<!-- <div class="form-group ">
		<div class="col-sm-3 control-label" style="margin-left: 25px;"><p> 
	  ...
	  <script>
		...
		if(a==2){ 
		document.getElementById("adr").innerHTML  ="<?php echo $entry_postcode; ?>";
		document.getElementById("input-payment-address-2").placeholder = "<?php echo $entry_postcode; ?>";
		}
		}
		</script>
    ...
    <div class="form-group required">
      <label class="col-sm-2 control-label" id="adr" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
      <div class="col-sm-10">
