            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_ban') { ?>
					<option value="content_ban" selected="selected">Slider 1</option>
					<?php } else { ?>
					<option value="content_ban">Slider 1</option>
					<?php } ?>
					<?php if ($layout_module['position'] == 'content_ban1') { ?>
					<option value="content_ban1" selected="selected">Slider 2</option>
					<?php } else { ?>
					<option value="content_ban1">Slider 2</option>
					<?php } ?>
...
function addModule() {
	...
	html += '    <option value="content_ban1">Slider 2 </option>';
	html += '    <option value="content_ban">Slider 1 </option>';
    html += '  </select></td>';
